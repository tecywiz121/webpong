...
from .views import GameView, GameCreateView, GameListView, game_detail_ajax, game_send_action_ajax
...
urlpatterns = patterns('',
    ...
    url(r'^ajax/game/(?P<pk>[0-9]+)/action/$', game_send_action_ajax, name='pong-game-action-ajax'),
)
